...
public class EnqueuePlaylistAction(
    IUser user,
    PlaylistInformation? playlistInformation,
    IEnumerable<ExtendedTrackItem> trackItems) : QueueAction(user, QueueActionType.AddPlaylist)
{
    ...
    public override string Stringify() => $"enqueued {Count} tracks";
}