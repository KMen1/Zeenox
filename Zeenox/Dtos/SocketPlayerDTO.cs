...
public class SocketPlayerDTO(PlayerState state, TrackRepeatMode repeatMode, int volume, double position, bool isAutoPlayEnabled, ImmutableArray<SocketUserDTO> listeners)
{
